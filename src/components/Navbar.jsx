    ...
    <>
      ...
      <nav className="sticky top-0 z-50 border-b border-gray-200 bg-white/95 shadow-[0_4px_20px_rgba(15,23,42,0.06)] backdrop-blur">
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          >
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#0f172a] text-lg font-bold text-white shadow-lg shadow-slate-900/20">
              IK
            </div>

            <div>
              <h1 className="text-[17px] font-bold leading-tight tracking-tight text-[#0f172a]">
                Ibn Khaldun
              </h1>
          ...
          <div className="hidden items-center gap-1 lg:flex">
            ...
            <Link
              to="/login"
              className="ml-3 flex items-center gap-2 rounded-xl bg-[#0f172a] px-5 py-2.5 text-sm font-semibold text-white shadow-md shadow-slate-900/15 transition hover:bg-blue-700"
            >
              Login
              <FiArrowRight />
            </Link>
          ...
          <button
            ...
            className="flex h-11 w-11 items-center justify-center rounded-xl border border-gray-200 bg-gray-50 text-xl text-[#0f172a] transition hover:border-blue-200 hover:bg-blue-50 lg:hidden"
          >
            {isOpen ? <FiX /> : <FiMenu />}
          </button>
